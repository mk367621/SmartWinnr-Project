...
Tech stack - MongoDB, Express.js, Node.js, Angular

Step 1 - Created a directory called 'backend' for backend and installed dependencies
express, mongoose, bcrypt, jsonwebtoken, dotenv and cors.
